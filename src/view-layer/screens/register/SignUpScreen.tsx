      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.subtitleContainer}>
            ...
            <TextInput placeholder="Idade" dense style={styles.inputStyle} />

            <TextInput placeholder="E-mail" dense style={styles.inputStyle} />

            <TextInput placeholder="Estado" dense style={styles.inputStyle} />

            <TextInput placeholder="Cidade" dense style={styles.inputStyle} />

            <TextInput placeholder="Endereço" dense style={styles.inputStyle} />

            <TextInput placeholder="Telefone" dense style={styles.inputStyle} />
            ...
            <TextInput placeholder="Senha" dense style={styles.inputStyle} />
